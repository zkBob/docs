...
BOB inventory is handled with a [multi-sig Safe](https://gnosis-safe.io/app/matic:0xd4a3D9Ca00fa1fD8833D560F9217458E61c446d8/home) by a distributed reserve board. The safe does not have any administrative rights in regards to zkBOB; its only function is to oversee the inventory process. Additional decentralization measures are in development to maintain and balance optimal BOB inventory based on usage and demand.

BOB stability is maintained through the [Uniswap v3 AMM concentrated liquidity algorithm](https://docs.uniswap.org/protocol/concepts/V3-overview/concentrated-liquidity). Below are inventory increases that have occurred to date.
...
2. 1,000,000 BOB for [Uniswap pool creation](https://zkbob.page.link/getBOB).\
...
3. 1,000,000 BOB to support[ ](https://info.uniswap.org/#/polygon/pools/0xe65a85bf544b4e4017cdb12387844683a9c86641)additional Uniswap pool.\
...
2. 1,000,000 BOB for [Uniswap pool creation](https://app.uniswap.org/#/swap/?chain=ethereum\&inputCurrency=0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48\&outputCurrency=0xB0B195aEFA3650A6908f15CdaC7D92F8a5791B0B).\
...
3. 5,999,950.94 BOB to bolster Uniswap pool.\
...
1. 1,000,000 BOB for [Uniswap pool creation](https://app.uniswap.org/#/swap/?chain=optimism\&inputCurrency=0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48\&outputCurrency=0xB0B195aEFA3650A6908f15CdaC7D92F8a5791B0B).\
