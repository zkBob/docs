...
:heavy\_check\_mark: BOB is acquired through swaps using apps like [1inch](https://app.1inch.io/#/137/unified/swap/USDC/BOB), [Uniswap v3,](get-bob-on-uniswap-v3.md) [Metamask,](swap-bob-with-metamask-swap.md) [Kyberswap](https://kyberswap.com/swap/bnb/bob-to-busd), and others. BOB can also be transferred between users in a shielded form using the zkBOB application.
